                        ...
                        <form action="{{ route('pegawai.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" class="form-control @error('gaji') is-invalid @enderror"
                                    name="gaji" value="{{ old('gaji') }}" placeholder="Masukkan Gaji Pegawai">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" class="form-control @error('no_ktp') is-invalid @enderror"
                                    name="no_ktp" value="{{ old('no_ktp') }}" placeholder="Masukkan No KTP Pegawai">
                            ...
                            <button type="submit" class="btn btn-md btn-primary rounded-pill mt-3">SIMPAN</button>
                            <a href="{{ url('pegawai')}}" class="btn btn-md btn-dark rounded-pill mt-3">Kembali</a>
